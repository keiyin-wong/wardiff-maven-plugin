 ...
 */
public class InvalidCompareFileConfigurationException
    extends MojoExecutionException
{
     ...
     */
    public InvalidCompareFileConfigurationException( String string )
    {
        super( string );
    }
     ...
     */
    public InvalidCompareFileConfigurationException( String string, Throwable throwable )
    {
